...
const PlacePhoto = ({idComment, idPhoto, user, placeName, ubication, price, userImage, placeImage, likes, comments}) => {
        ...
        <div className={styles.photo_container}>
            ...
            <div className={styles.buttons}>
                ...
                <div className={styles.button_container}>
                    ...
                    {/* <button  className={styles.btn} type="button" onClick={() => setOpenComment(true)}></button> */}
