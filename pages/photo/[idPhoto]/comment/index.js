...
import { getAllComment } from '../../../../firebase/getAllComment'
import { MenuContext } from "../../../../components/MenuContext/MenuContext";

import styles from './Comment.module.css'

const Comments = () => {
    const { comments } = useContext(MenuContext)
    const router = useRouter();
    const id = router.query.idPhoto
            ...
            <div className={styles.commentContainer}>
                {comments.map(comment => (
                    <Comment
                        ...
                        noLikes={comment.no_likes}
                        timePosted={comment.creation_date}
